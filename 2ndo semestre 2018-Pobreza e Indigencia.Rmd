...
EPH_provincias <- readRDS("EPH_provincias2.rds") # puede descargar la base de datos en el repositorio: https://github.com/NahuelBargas/sitio-personal/ y también el script utilizado para preparlar, de nombre  "Pobreza e Indigencia 2ndo semestre 2018-Preparación de base.R"
```
# Introducción 
...
pero con datos del segundo semestre de dicho año. En esta ocasión, a su vez,  podra acceder al archivo [Rmd](https://github.com/NahuelBargas/sitio-personal/2ndo_semestre_2018-Pobreza_e_Indigencia.Rmd) donde figuran los comandos que utilizé en R , por si desea replicar los resultados obtenidos.
